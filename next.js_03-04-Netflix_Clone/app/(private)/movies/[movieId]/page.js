...
const MovieDetail = async ({ params: { movieId } }) => {
  ...
  const videoKey = await getVideoKeys(movieId);
  ...
  return (
    <div className="md:container px-10 mx-auto py-5">
      ...
      <div className="flex items-center mt-3 md:mt-4 gap-3 ">
        <Link
          href={`/movies`}
          className="bg-white rounded-md py-1 md:py-2 md:px-4 w-auto text-sm lg:text-lg font-semibold flex flex-row items-center hover:bg-neutral-300 mt-2  "
        >
